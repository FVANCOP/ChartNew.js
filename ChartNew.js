...
window.Chart = function (context) {
    ...
    this.Radar = function (data, options) {
        ...
        chart.Radar.defaults = mergeChartConfig(chart.defaults.annotateDefualts, chart.Radar.defaults)
    ...
    this.Pie = function (data, options) {
        ...
        // merge annotate defaults
        chart.Pie.defaults = mergeChartConfig(chart.defaults.annotateDefualts, chart.Pie.defaults)
    ...
    this.Doughnut = function (data, options) {
        ...
        // merge annotate defaults
        chart.Doughnut.defaults = mergeChartConfig(chart.defaults.annotateDefualts, chart.Doughnut.defaults)
    ...
    this.Line = function (data, options) {
        ...
        // merge annotate defaults
        chart.Line.defaults = mergeChartConfig(chart.defaults.annotateDefualts, chart.Line.defaults)
    ...
    this.StackedBar = function (data, options) {
        ...
        // merge annotate defaults
        chart.StackedBar.defaults = mergeChartConfig(chart.defaults.annotateDefualts, chart.StackedBar.defaults)
    ...
    this.HorizontalStackedBar = function (data, options) {
        ...
        // merge annotate defaults
        chart.HorizontalStackedBar.defaults = mergeChartConfig(chart.defaults.annotateDefualts, chart.HorizontalStackedBar.defaults)
    ...
    this.Bar = function (data, options) {
        ...
        // merge annotate defaults
        chart.Bar.defaults = mergeChartConfig(chart.defaults.annotateDefualts, chart.Bar.defaults);
    ...
    this.HorizontalBar = function (data, options) {
        ...
        // merge annotate defaults
        chart.HorizontalBar.defaults = mergeChartConfig(chart.defaults.annotateDefualts, chart.HorizontalBar.defaults)
    ...
    chart.defaults = {};
    chart.defaults.annotateDefualts = {
        //annotateDisplay: false,   // not sure if we should include this
        annotateFunction: "mousemove",
        annotateFontFamily: "'Arial'",
        annotateBorder: 'none', 
