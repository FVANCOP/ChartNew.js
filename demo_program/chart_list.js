...
lst[lst.length]=["annotate_circular","../Samples/annotate_for_circular_charts.html","90.Add-ins add-ins annotate.js","","example of annotates position for circular charts"];
...
lst[lst.length]=["attendance_chart","../Samples/attendance_chart.html","90.Add-ins add-ins shapesInChart","","example of attendance chart"];
lst[lst.length]=["background_for_bars","../Samples/bars_with_background_color.html","90.Add-ins add-ins shapesInChart","","example of charts with background colors"];
lst[lst.length]=["highlight5","../Samples/highLight5.html","90.Add-ins add-ins shapesInChart","","example highlights with rectangle"];
...
lst[lst.length]=["Percentage","../Samples/issue_475.html","90.Add-ins add-ins shapesInChart specialInChartData stats","","example with percentage as label"];
